...
import com.wang.javaL.IO.utils.ExcelUtils;
...
public class East5CompareTools {
    ...
    public Map<String, List<String>> compare(String filePath1, String fieldPath2, int sheetIx1, int sheetIx2){
        Map<String,List<String>> res = new HashMap<>();
        Map<String, Object> file1 = new ExcelUtils().execute(filePath1, sheetIx1, ReportHandleProcessor.TB_FIELDS);
        Map<String, Object> file2 = new ExcelUtils().execute(fieldPath2, sheetIx2, ReportHandleProcessor.TB_FIELDS);
